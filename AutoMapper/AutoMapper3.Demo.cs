// 下面的这个代码只能适用于AutoMapper3.0
// 现在已经更新到5.1.1版本了，现在的这些函数都不能用了，我觉得这个映射挺方便的，不用再为了前端写一堆函数过滤，每次用autoMapper过滤一下就行了
// 这个工具就是为了entity像viewModel转化用的，很方便的自定义转换
using System;
...
namespace ConsoleApplication2 {
    class Program {
        static void Main (string[] args) {
            ...
            Console.WriteLine ();
            //Console.ReadKey();
            //14.Flatten特性 Store.Name.FirtName=FlattenName.NameFirstname  Flatten变平，单调
            Mapper.Reset ();
