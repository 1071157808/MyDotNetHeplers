...
namespace LaoXiong.Common.ClassLibrary
{
    /// <summary> 
    /// SqlServer数据访问帮助类 在<connectionStrings></connectionStrings>中必须包含<add name="ConStr"/>
    /// </summary> 
    public sealed class SqlHelper
    {
        ...
        /// </summary> 
        /// <returns></returns> 
        public static string GetConnSting(string ServerIP, string UserName, string PassWord, String DbName)
        {
            return "Data Source=" + ServerIP + ";Initial Catalog=Northwind;User ID=" + UserName + ";Password=" + PassWord + ";database=" + DbName;
        }
        ...
        /// </summary> 
        /// <returns></returns> 
        public static SqlConnection GetConnection(string ServerIP, string UserName, string PassWord, string DbName)
        {
            SqlConnection Connection = new SqlConnection(SqlHelper.GetConnSting(ServerIP, UserName, PassWord, DbName));
            return Connection;
        }
